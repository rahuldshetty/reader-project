<script>
  ...
  const handleAddFolder = async () => {
    ...
    try{
      ...
      toastStore.add(TOAST_MESSAGE_TYPE.ERROR, "Unable to create folder. Please make sure folder doesn't exist.")
    }
...
<dialog
  class="modal"
  class:modal-open={$active_modal == MODAL_TYPE.ADD_FOLDER}
>
